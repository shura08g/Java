...
/*    static char[] chars2 = ("abcdefghijklmnopqrstuvwxyz" + 
                           "ABCDEFGHIJKLMNOPQRSTUVWXYZ").toCharArray();
    
    public static class Character implements Generator<java.lang.Character> {
        @Override
        public java.lang.Character next() {
            return chars2[r.nextInt(chars2.length)];
        }
    }
*/    
    public static class Character implements Generator<java.lang.Character> {
    ...
    public static class String extends CountingGenerator.String implements Generator<java.lang.String> {
