...
public class Dubstep {
    ...
    public static String SongDecoder(String song) {
        String originSong = song.replaceAll("WUB", " ").trim();
        //originSong = originSong.replaceAll("\\s+", " ");
        originSong = originSong.replaceAll(" +", " ");
        return originSong;
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(SongDecoder2("WUBWEWUBAREWUBWUBTHEWUBCHAMPIONSWUBMYWUBFRIENDWUB"));
    }
}
